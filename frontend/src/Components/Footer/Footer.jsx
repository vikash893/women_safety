                ...
                <div className="row">
                  <div className="col-lg-5 footer_logo mb-4 mb-lg-0">
                    ...
                    <p className="footer_text" style={{ textAlign: "justify" }}>
                      At AegisHer, we're dedicated to making Secure website
                  ...
                  <div className="col-lg-4 px-lg-5 mb-4 mb-lg-0">
                    ...
                    <p className="footer_text">
                      <a>rajputvishnu2513@gmail.com</a>
                      <br />
                  ...
                  <div className="col-lg-3 mb-4 mb-lg-0">
                    ...
                    <p>
                      <a
                        href="https://www.linkedin.com/in/vishnu-singh-098033324/"
                      ...
                      <a
                        href="https://github.com/vish3456"
                        className="footer_social_media_icon"
                        style={{ color: "white" }}
                      >
                        <BsGithub size={25} />
                  ...
                  <div className="col-12 footer_credits text-center">
                    <span>
                      © 2026 <a>AegisHer</a>™. All Rights Reserved.
                    </span>
                  </div>
                </div>
              </div>
